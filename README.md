...
papers which mention the biological target in either the title or abstract.
The files only contain entries added to PubMed since around 2000, so entries
before that data are incomplete.
